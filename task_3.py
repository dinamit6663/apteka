...
from t4 import find_business
from get_lines import lonlat_distance
...
'''
python3 task_3.py Москва, Новопеределкино, Лукинская ул., 10
python3 task_3.py Москва, Новопеределкино
'''